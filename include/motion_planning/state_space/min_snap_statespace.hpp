...
public:
    MinSnapStateSpace( int dimension, double v_max, double a_max, const Eigen::VectorXd& w_vel, const Eigen::VectorXd& w_accel, const Eigen::VectorXd& w_snap, unsigned int seed = 42);
    ...
    Eigen::MatrixXd calculateCombinedHessian( double T, int axis) const;
