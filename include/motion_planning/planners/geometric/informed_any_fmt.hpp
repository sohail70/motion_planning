...
class InformedANYFMT : public Planner {
 public:
            InformedANYFMT(std::shared_ptr<StateSpace> statespace , std::shared_ptr<ProblemDefinition> problem_def , std::shared_ptr<ObstacleChecker> obs_checker);
