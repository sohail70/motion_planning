...
# Shared parameters for each State Space (tuned for non-anytime batch sampling)
STATE_SPACES = {
    "R2": {
...
# =====================================================================
# 2. YAML GENERATOR FUNCTION (NO DELTA/EPSILON)
# =====================================================================
def create_yaml(algo_name, space_name, seed, params, filename):
    
    # We embed the algorithm, space, and seed into the experiment name 
...
# =====================================================================
def run_experiments():
    temp_yaml_file = "temp_non_anytime_config.yaml"
    ...
    if os.path.exists(temp_yaml_file):
        os.remove(temp_yaml_file)
    print("\n[SUCCESS] All non-anytime experiment batches finished!")
