...
std::unique_ptr<Planner> PlannerFactory::createPlanner(PlannerType type, std::unique_ptr<StateSpace> statespace, std::unique_ptr<ProblemDefinition> problem, std::shared_ptr<ObstacleChecker> obs_checker ) {  
