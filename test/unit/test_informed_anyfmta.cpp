...
int main(int argc, char **argv) {
    ...
    */
    ...
    auto node = std::make_shared<rclcpp::Node>("informed_anyfmta_visualizer", rclcpp::NodeOptions().parameter_overrides({
    ...
    std::shared_ptr<Planner> planner = PlannerFactory::getInstance().createPlanner(PlannerType::InformedANYFMTA, statespace,problem_def, obstacle_checker);
