...
int main(int argc, char **argv) {
    ...
    */
    ...
    // Create ROS node
    // auto node = std::make_shared<rclcpp::Node>("kinodynamic_fmtx");
    auto node = std::make_shared<rclcpp::Node>("kinodynamic_fmtx_visualizer", rclcpp::NodeOptions().parameter_overrides({
    ...
    std::shared_ptr<Planner> planner = PlannerFactory::getInstance().createPlanner(PlannerType::KinodynamicFMTX, statespace,problem_def, obstacle_checker);
