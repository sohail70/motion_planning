...
//     // --- Define a sequence of waypoints (A, B, C, D, E) ---
...
int main(int argc, char** argv) {
    ...
    // --- Plan each segment backward and ANALYZE the output ---
    for (size_t i = 0; i < waypoints.size() - 1; ++i) {
