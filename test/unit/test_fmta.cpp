...
int main(int argc, char **argv) {
    ...
    */
    ...
    auto node = std::make_shared<rclcpp::Node>("fmta_visualizer", rclcpp::NodeOptions().parameter_overrides({
    ...
    std::unique_ptr<Planner> planner = PlannerFactory::getInstance().createPlanner(PlannerType::FMTA, statespace,problem_def, obstacle_checker);
